...
= 4.5.18 =
 * Add : Admin notice about merging the free version of WP Meta Seo into the Pro version

= 4.5.17 =
 * Fix : Error when import meta data from AioSeo plugin
 * Fix : Saving meta title for category
